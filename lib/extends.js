...
var RM = {
    ...
    SheetManager: (function () {
        ...
        function add(sheetViewName) {
            ...
            // - создать класс-родитель для sheet
            // - в нем прописать пустой класс renderChildren()
            // ИЛИ
            // - объект events для навешивания событий убрать
            // - навешивать на каждую вьюху
            // - навешивать событие во вьюхах, в методе render и прям внутри колбэка рендерить содержимое renderChildren(), а саму ее убрать
